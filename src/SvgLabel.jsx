...
export default function SvgLabel({
  ...
  const cards = [
    { title: "選択地点名", height: 50 },
    { title: "説明2", height: 220 },
    { title: "説明3", height: 220 },
    { title: "説明4", height: 190 },
    { title: "説明5", height: 180 },
    { title: "説明6", height: 550 },
    { title: "説明7", height: 420 },
  ];
  ...
  const svgHeight =
    100 +
    cards.reduce((sum, card) => sum + card.height + margin, 0);
      ...
      >
        ...
        {cards.map((card, i) => {
          ...
          const y =
            ...
            cards
              .slice(0, i)
              .reduce((sum, c) => sum + c.height + margin, 0);
                    ...
                    >
                      ...
                      {year === "1990年度" ? (
                        ...
                        <>
                          <div>
                            前年度：
                            {previousPeople.toLocaleString()} 人
                          </div>

                          <div>
                            今年度：
                            {currentPeople.toLocaleString()} 人
                          </div>
                    ...
                    >
                      ...
                      {year === "1990年度" ? (
                        ...
                        <>
                          <div>
                            前年度：
                            {previousLabelPeople.toLocaleString()}人
                          </div>

                          <div>
                            今年度：
                            {currentLabelPeople.toLocaleString()}人
                          </div>
                          ...
                          {(() => {
                            const labelGaugeRate =
                              previousLabelPeople === 0
                                ? (currentLabelPeople === 0 ? 0 : 100)
                                : ((currentLabelPeople - previousLabelPeople) /
                                  previousLabelPeople) * 100;

                            const labelBarWidth =
                              Math.min(Math.abs(labelGaugeRate), 100) * 1.1;
                    ...
                    >
...

                      {
                        (() => {
                          ...
                          const total =
                            data
                              .filter(item => item.purpose !== "代_全機関_全目的")
                              .reduce(
...

                      {
                        (() => {
                          ...
                          const data =
                            transportationData.filter(item =>
                              item.from === destination &&
                              item.to === prefecture
                            );
        ...
        <text
          ...
          fontSize="30"
        >
          {prefecture.includes("道") ? prefecture
            : prefecture.includes("東京") ? `${prefecture}都`
              : prefecture.includes("大阪") || prefecture.includes("京都") ? `${prefecture}府`
                : `${prefecture}県`}
        </text>
